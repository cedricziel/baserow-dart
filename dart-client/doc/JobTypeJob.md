...
**workspaceId** | **int** | The workspace ID where the Airtable base must be imported into. | 
**resource** | [**ImportResource**](ImportResource.md) |  | 
**database** | [**ApplicationApplication**](ApplicationApplication.md) |  | 
**airtableShareId** | **String** | Public ID of the shared Airtable base that must be imported. | 
...
**originalField** | [**Field**](Field.md) |  | [readonly] 
**duplicatedField** | [**FieldSerializerWithRelatedFields**](FieldSerializerWithRelatedFields.md) |  | [readonly] 
