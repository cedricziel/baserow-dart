...
// tests for PatchedSettings
void main() {
  // final instance = PatchedSettings();

  group('test PatchedSettings', () {
    // Indicates whether new users can create a new account when signing up.
    // bool allowNewSignups
    test('to test the property `allowNewSignups`', () async {
      // TODO
    });
    ...
    test('to test the property `showAdminSignupPage`', () async {
      // TODO
    });
    ...
    test('to test the property `verifyImportSignature`', () async {
      // TODO
    });
