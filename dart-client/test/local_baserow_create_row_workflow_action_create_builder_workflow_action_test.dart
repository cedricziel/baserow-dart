...
// tests for LocalBaserowCreateRowWorkflowActionCreateBuilderWorkflowAction
void main() {
  // final instance = LocalBaserowCreateRowWorkflowActionCreateBuilderWorkflowAction();

  group('test LocalBaserowCreateRowWorkflowActionCreateBuilderWorkflowAction', () {
    // int id
