...
// tests for RollupFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = RollupFieldFieldSerializerWithRelatedFields();

  group('test RollupFieldFieldSerializerWithRelatedFields', () {
    // int id
