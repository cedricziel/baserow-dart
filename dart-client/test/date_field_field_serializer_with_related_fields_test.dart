...
// tests for DateFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = DateFieldFieldSerializerWithRelatedFields();

  group('test DateFieldFieldSerializerWithRelatedFields', () {
    // int id
