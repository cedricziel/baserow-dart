...
// tests for LocalBaserowDeleteRowWorkflowActionCreateBuilderWorkflowAction
void main() {
  // final instance = LocalBaserowDeleteRowWorkflowActionCreateBuilderWorkflowAction();

  group('test LocalBaserowDeleteRowWorkflowActionCreateBuilderWorkflowAction', () {
    // int id
