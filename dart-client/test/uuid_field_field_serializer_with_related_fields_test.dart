...
// tests for UUIDFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = UUIDFieldFieldSerializerWithRelatedFields();

  group('test UUIDFieldFieldSerializerWithRelatedFields', () {
    // int id
