...
// tests for ViewCreateView
void main() {
  // final instance = ViewCreateView();

  group('test ViewCreateView', () {
    // String name
    ...
    // OwnershipTypeEnum ownershipType (default value: OwnershipTypeEnum.collaborative)
    ...
    test('to test the property `filtersDisabled`', () async {
      // TODO
    });

    // RowIdentifierTypeEnum rowIdentifierType
    test('to test the property `rowIdentifierType`', () async {
      // TODO
    });

    // RowHeightSizeEnum rowHeightSize
    test('to test the property `rowHeightSize`', () async {
      // TODO
    });
    ...
    test('to test the property `cardCoverImageField`', () async {
      // TODO
    });
    ...
    // UserFile logoImage
    test('to test the property `logoImage`', () async {
      // TODO
    });

    // The text displayed on the submit button.
    // String submitText
    test('to test the property `submitText`', () async {
      // TODO
    });
    ...
    test('to test the property `submitAction`', () async {
      // TODO
    });
    ...
    test('to test the property `submitActionMessage`', () async {
      // TODO
    });
