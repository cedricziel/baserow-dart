...
// tests for URLFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = URLFieldFieldSerializerWithRelatedFields();

  group('test URLFieldFieldSerializerWithRelatedFields', () {
    // int id
