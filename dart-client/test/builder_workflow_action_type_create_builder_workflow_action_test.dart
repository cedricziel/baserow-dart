...
// tests for BuilderWorkflowActionTypeCreateBuilderWorkflowAction
void main() {
  // final instance = BuilderWorkflowActionTypeCreateBuilderWorkflowAction();

  group('test BuilderWorkflowActionTypeCreateBuilderWorkflowAction', () {
    // int id
