...
// tests for ExampleRowResponseSerializerWithUserFieldNames
void main() {
  // final instance = ExampleRowResponseSerializerWithUserFieldNames();

  group('test ExampleRowResponseSerializerWithUserFieldNames', () {
