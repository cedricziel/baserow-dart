...
void main() {
  ...
  group('test ModelExport', () {
    ...
    test('to test the property `exporterType`', () async {
      // TODO
    });
    ...
    // bool csvIncludeHeader (default value: true)
    test('to test the property `csvIncludeHeader`', () async {
      // TODO
    });

    // Whether or not to generate the field names as header row at the top of the Excel file.
    // bool excelIncludeHeader (default value: true)
    test('to test the property `excelIncludeHeader`', () async {
      // TODO
    });
