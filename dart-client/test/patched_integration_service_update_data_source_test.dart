...
// tests for PatchedIntegrationServiceUpdateDataSource
void main() {
  // final instance = PatchedIntegrationServiceUpdateDataSource();

  group('test PatchedIntegrationServiceUpdateDataSource', () {
