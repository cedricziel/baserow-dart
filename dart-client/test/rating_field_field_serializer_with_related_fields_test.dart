...
// tests for RatingFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = RatingFieldFieldSerializerWithRelatedFields();

  group('test RatingFieldFieldSerializerWithRelatedFields', () {
    // int id
