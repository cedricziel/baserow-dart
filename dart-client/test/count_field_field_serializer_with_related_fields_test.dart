...
// tests for CountFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = CountFieldFieldSerializerWithRelatedFields();

  group('test CountFieldFieldSerializerWithRelatedFields', () {
    // int id
