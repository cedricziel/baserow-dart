...
// tests for AppAuthProviderBaseAppAuthProvider
void main() {
  // final instance = AppAuthProviderBaseAppAuthProvider();

  group('test AppAuthProviderBaseAppAuthProvider', () {
    ...
    // int passwordFieldId
    test('to test the property `passwordFieldId`', () async {
      // TODO
    });
    ...
    // String emailAttrKey
    test('to test the property `emailAttrKey`', () async {
      // TODO
    });

    // The key in the SAML response that contains the first name of the user.
    // String firstNameAttrKey
    test('to test the property `firstNameAttrKey`', () async {
      // TODO
    });
    ...
    test('to test the property `lastNameAttrKey`', () async {
      // TODO
    });
