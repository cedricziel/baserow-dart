...
// tests for LinkRowFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = LinkRowFieldFieldSerializerWithRelatedFields();

  group('test LinkRowFieldFieldSerializerWithRelatedFields', () {
    // int id
