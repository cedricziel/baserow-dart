...
// tests for MultipleCollaboratorsFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = MultipleCollaboratorsFieldFieldSerializerWithRelatedFields();

  group('test MultipleCollaboratorsFieldFieldSerializerWithRelatedFields', () {
    // int id
