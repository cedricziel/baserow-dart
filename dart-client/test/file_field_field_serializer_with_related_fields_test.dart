...
// tests for FileFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = FileFieldFieldSerializerWithRelatedFields();

  group('test FileFieldFieldSerializerWithRelatedFields', () {
    // int id
