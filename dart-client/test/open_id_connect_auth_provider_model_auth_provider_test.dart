...
// tests for OpenIdConnectAuthProviderModelAuthProvider
void main() {
  // final instance = OpenIdConnectAuthProviderModelAuthProvider();

  group('test OpenIdConnectAuthProviderModelAuthProvider', () {
    // int id
