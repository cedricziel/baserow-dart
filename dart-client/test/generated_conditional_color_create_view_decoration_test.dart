...
// tests for GeneratedConditionalColorCreateViewDecoration
void main() {
  // final instance = GeneratedConditionalColorCreateViewDecoration();

  group('test GeneratedConditionalColorCreateViewDecoration', () {
