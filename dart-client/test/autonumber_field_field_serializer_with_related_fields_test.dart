...
// tests for AutonumberFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = AutonumberFieldFieldSerializerWithRelatedFields();

  group('test AutonumberFieldFieldSerializerWithRelatedFields', () {
    // int id
