...
// tests for DecoratorValueProviderTypeCreateViewDecoration
void main() {
  // final instance = DecoratorValueProviderTypeCreateViewDecoration();

  group('test DecoratorValueProviderTypeCreateViewDecoration', () {
