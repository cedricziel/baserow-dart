...
// tests for LocalBaserowAggregateRowsPublicDataSource
void main() {
  // final instance = LocalBaserowAggregateRowsPublicDataSource();

  group('test LocalBaserowAggregateRowsPublicDataSource', () {
    // Data source id.
    // int id
