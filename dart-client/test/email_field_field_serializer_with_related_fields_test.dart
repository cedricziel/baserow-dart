...
// tests for EmailFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = EmailFieldFieldSerializerWithRelatedFields();

  group('test EmailFieldFieldSerializerWithRelatedFields', () {
    // int id
