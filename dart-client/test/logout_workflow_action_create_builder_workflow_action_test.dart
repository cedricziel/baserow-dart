...
// tests for LogoutWorkflowActionCreateBuilderWorkflowAction
void main() {
  // final instance = LogoutWorkflowActionCreateBuilderWorkflowAction();

  group('test LogoutWorkflowActionCreateBuilderWorkflowAction', () {
    // int id
