...
// tests for PasswordFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = PasswordFieldFieldSerializerWithRelatedFields();

  group('test PasswordFieldFieldSerializerWithRelatedFields', () {
    // int id
