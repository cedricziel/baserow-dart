...
// tests for DecoratorValueProviderTypeViewDecoration
void main() {
  // final instance = DecoratorValueProviderTypeViewDecoration();

  group('test DecoratorValueProviderTypeViewDecoration', () {
    // int id
