...
// tests for LocalBaserowDeleteRowWorkflowActionBuilderWorkflowAction
void main() {
  // final instance = LocalBaserowDeleteRowWorkflowActionBuilderWorkflowAction();

  group('test LocalBaserowDeleteRowWorkflowActionBuilderWorkflowAction', () {
    // int id
