...
// tests for LongTextFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = LongTextFieldFieldSerializerWithRelatedFields();

  group('test LongTextFieldFieldSerializerWithRelatedFields', () {
    // int id
