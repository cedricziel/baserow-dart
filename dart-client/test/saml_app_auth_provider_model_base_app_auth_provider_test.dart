...
// tests for SamlAppAuthProviderModelBaseAppAuthProvider
void main() {
  // final instance = SamlAppAuthProviderModelBaseAppAuthProvider();

  group('test SamlAppAuthProviderModelBaseAppAuthProvider', () {
