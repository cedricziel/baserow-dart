...
// tests for LastModifiedByFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = LastModifiedByFieldFieldSerializerWithRelatedFields();

  group('test LastModifiedByFieldFieldSerializerWithRelatedFields', () {
    // int id
