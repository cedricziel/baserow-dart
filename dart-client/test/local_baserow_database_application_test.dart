...
// tests for LocalBaserowDatabaseApplication
void main() {
  // final instance = LocalBaserowDatabaseApplication();

  group('test LocalBaserowDatabaseApplication', () {
    // int id
    ...
    // List<TableSerializerWithFields> tables (default value: const [])
    ...
    // List<LocalBaserowView> views (default value: const [])
