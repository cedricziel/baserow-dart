...
// tests for LocalBaserowAggregateRowsCreateDataSource
void main() {
  // final instance = LocalBaserowAggregateRowsCreateDataSource();

  group('test LocalBaserowAggregateRowsCreateDataSource', () {
