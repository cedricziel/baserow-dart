...
// tests for LocalBaserowTableDataSyncListDataSyncPropertiesRequest
void main() {
  // final instance = LocalBaserowTableDataSyncListDataSyncPropertiesRequest();

  group('test LocalBaserowTableDataSyncListDataSyncPropertiesRequest', () {
