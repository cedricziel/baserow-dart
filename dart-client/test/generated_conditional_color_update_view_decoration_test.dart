...
// tests for GeneratedConditionalColorUpdateViewDecoration
void main() {
  // final instance = GeneratedConditionalColorUpdateViewDecoration();

  group('test GeneratedConditionalColorUpdateViewDecoration', () {
