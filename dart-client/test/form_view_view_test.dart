...
// tests for FormViewView
void main() {
  // final instance = FormViewView();

  group('test FormViewView', () {
    // int id
    ...
    // List<ViewFilter> filters (default value: const [])
    test('to test the property `filters`', () async {
      // TODO
    });

    // List<ViewFilterGroup> filterGroups (default value: const [])
    test('to test the property `filterGroups`', () async {
      // TODO
    });

    // List<ViewSort> sortings (default value: const [])
    test('to test the property `sortings`', () async {
      // TODO
    });

    // List<ViewGroupBy> groupBys (default value: const [])
    test('to test the property `groupBys`', () async {
      // TODO
    });

    // List<ViewDecoration> decorations (default value: const [])
    test('to test the property `decorations`', () async {
      // TODO
    });
    ...
    test('to test the property `publicViewHasPassword`', () async {
      // TODO
    });

    // bool showLogo
    test('to test the property `showLogo`', () async {
      // TODO
    });
    ...
    // int ownedById
    test('to test the property `ownedById`', () async {
      // TODO
    });
