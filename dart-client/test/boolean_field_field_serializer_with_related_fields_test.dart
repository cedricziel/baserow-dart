...
// tests for BooleanFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = BooleanFieldFieldSerializerWithRelatedFields();

  group('test BooleanFieldFieldSerializerWithRelatedFields', () {
    // int id
