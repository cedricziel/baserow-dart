...
// tests for PatchedUpdatePage
void main() {
  // final instance = PatchedUpdatePage();

  group('test PatchedUpdatePage', () {
    // String name
    ...
    // List<PathParam> pathParams (default value: const [])
    test('to test the property `pathParams`', () async {
      // TODO
    });
