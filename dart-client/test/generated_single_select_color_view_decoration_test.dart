...
// tests for GeneratedSingleSelectColorViewDecoration
void main() {
  // final instance = GeneratedSingleSelectColorViewDecoration();

  group('test GeneratedSingleSelectColorViewDecoration', () {
    // int id
