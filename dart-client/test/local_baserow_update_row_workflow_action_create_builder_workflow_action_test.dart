...
// tests for LocalBaserowUpdateRowWorkflowActionCreateBuilderWorkflowAction
void main() {
  // final instance = LocalBaserowUpdateRowWorkflowActionCreateBuilderWorkflowAction();

  group('test LocalBaserowUpdateRowWorkflowActionCreateBuilderWorkflowAction', () {
    // int id
