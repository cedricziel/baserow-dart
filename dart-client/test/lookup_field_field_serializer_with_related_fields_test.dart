...
// tests for LookupFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = LookupFieldFieldSerializerWithRelatedFields();

  group('test LookupFieldFieldSerializerWithRelatedFields', () {
    // int id
