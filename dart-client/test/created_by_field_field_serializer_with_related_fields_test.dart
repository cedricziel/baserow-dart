...
// tests for CreatedByFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = CreatedByFieldFieldSerializerWithRelatedFields();

  group('test CreatedByFieldFieldSerializerWithRelatedFields', () {
    // int id
