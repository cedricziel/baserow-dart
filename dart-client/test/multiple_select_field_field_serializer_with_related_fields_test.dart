...
// tests for MultipleSelectFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = MultipleSelectFieldFieldSerializerWithRelatedFields();

  group('test MultipleSelectFieldFieldSerializerWithRelatedFields', () {
    // int id
