...
// tests for PatchedExampleUpdateRowRequestSerializerWithUserFieldNames
void main() {
  // final instance = PatchedExampleUpdateRowRequestSerializerWithUserFieldNames();

  group('test PatchedExampleUpdateRowRequestSerializerWithUserFieldNames', () {
