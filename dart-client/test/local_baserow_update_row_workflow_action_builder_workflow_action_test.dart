...
// tests for LocalBaserowUpdateRowWorkflowActionBuilderWorkflowAction
void main() {
  // final instance = LocalBaserowUpdateRowWorkflowActionBuilderWorkflowAction();

  group('test LocalBaserowUpdateRowWorkflowActionBuilderWorkflowAction', () {
    // int id
