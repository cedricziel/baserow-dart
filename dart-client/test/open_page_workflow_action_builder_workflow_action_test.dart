...
// tests for OpenPageWorkflowActionBuilderWorkflowAction
void main() {
  // final instance = OpenPageWorkflowActionBuilderWorkflowAction();

  group('test OpenPageWorkflowActionBuilderWorkflowAction', () {
    // int id
