...
// tests for AIFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = AIFieldFieldSerializerWithRelatedFields();

  group('test AIFieldFieldSerializerWithRelatedFields', () {
    // int id
