...
// tests for PublicBuilderWorkflowActionTypeBuilderWorkflowAction
void main() {
  // final instance = PublicBuilderWorkflowActionTypeBuilderWorkflowAction();

  group('test PublicBuilderWorkflowActionTypeBuilderWorkflowAction', () {
    // int id
