...
// tests for GeneratedSingleSelectColorCreateViewDecoration
void main() {
  // final instance = GeneratedSingleSelectColorCreateViewDecoration();

  group('test GeneratedSingleSelectColorCreateViewDecoration', () {
