...
// tests for LastModifiedFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = LastModifiedFieldFieldSerializerWithRelatedFields();

  group('test LastModifiedFieldFieldSerializerWithRelatedFields', () {
    // int id
