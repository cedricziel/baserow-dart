...
// tests for ExampleRowRequestSerializerWithUserFieldNames
void main() {
  // final instance = ExampleRowRequestSerializerWithUserFieldNames();

  group('test ExampleRowRequestSerializerWithUserFieldNames', () {
