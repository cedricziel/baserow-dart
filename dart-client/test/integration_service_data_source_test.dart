...
// tests for IntegrationServiceDataSource
void main() {
  // final instance = IntegrationServiceDataSource();

  group('test IntegrationServiceDataSource', () {
    // Data source id.
    // int id
    ...
    // Map<String, Object> contextData (default value: const {})
    test('to test the property `contextData`', () async {
      // TODO
    });

    // The schema context data of the service.
    // Map<String, Object> contextDataSchema (default value: const {})
    test('to test the property `contextDataSchema`', () async {
      // TODO
    });
    ...
    // String rowId
    test('to test the property `rowId`', () async {
      // TODO
    });
    ...
    test('to test the property `aggregationType`', () async {
      // TODO
    });

    // The field mapping associated with this service.
    // List<LocalBaserowTableServiceFieldMapping> fieldMappings (default value: const [])
    test('to test the property `fieldMappings`', () async {
      // TODO
    });
