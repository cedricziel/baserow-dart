...
// tests for SingleSelectFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = SingleSelectFieldFieldSerializerWithRelatedFields();

  group('test SingleSelectFieldFieldSerializerWithRelatedFields', () {
    // int id
