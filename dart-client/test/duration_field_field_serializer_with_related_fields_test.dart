...
// tests for DurationFieldFieldSerializerWithRelatedFields
void main() {
  // final instance = DurationFieldFieldSerializerWithRelatedFields();

  group('test DurationFieldFieldSerializerWithRelatedFields', () {
    // int id
