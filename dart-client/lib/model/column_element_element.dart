...
class ColumnElementElement {
  /// Returns a new [ColumnElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ColumnElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ColumnElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ColumnElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ColumnElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ColumnElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ColumnElementElement(
  ...
  static List<ColumnElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ColumnElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ColumnElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ColumnElementElement> mapFromJson(dynamic json) {
    final map = <String, ColumnElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ColumnElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ColumnElementElement-objects as value to a dart map
  static Map<String, List<ColumnElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ColumnElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ColumnElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
