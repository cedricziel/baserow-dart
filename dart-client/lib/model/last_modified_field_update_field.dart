...
class LastModifiedFieldUpdateField {
  /// Returns a new [LastModifiedFieldUpdateField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LastModifiedFieldUpdateField &&
    other.name == name &&
    other.type == type &&
  ...
  @override
  String toString() => 'LastModifiedFieldUpdateField[name=$name, type=$type, description=$description, dateFormat=$dateFormat, dateIncludeTime=$dateIncludeTime, dateTimeFormat=$dateTimeFormat, dateShowTzinfo=$dateShowTzinfo, dateForceTimezone=$dateForceTimezone, dateForceTimezoneOffset=$dateForceTimezoneOffset]';
  ...
  /// Returns a new [LastModifiedFieldUpdateField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LastModifiedFieldUpdateField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LastModifiedFieldUpdateField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LastModifiedFieldUpdateField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LastModifiedFieldUpdateField(
  ...
  static List<LastModifiedFieldUpdateField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LastModifiedFieldUpdateField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LastModifiedFieldUpdateField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LastModifiedFieldUpdateField> mapFromJson(dynamic json) {
    final map = <String, LastModifiedFieldUpdateField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LastModifiedFieldUpdateField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LastModifiedFieldUpdateField-objects as value to a dart map
  static Map<String, List<LastModifiedFieldUpdateField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LastModifiedFieldUpdateField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LastModifiedFieldUpdateField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
