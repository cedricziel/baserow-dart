...
class MultipleSelectFieldField {
  /// Returns a new [MultipleSelectFieldField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MultipleSelectFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'MultipleSelectFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description, selectOptions=$selectOptions]';
  ...
  /// Returns a new [MultipleSelectFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MultipleSelectFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MultipleSelectFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MultipleSelectFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MultipleSelectFieldField(
  ...
  static List<MultipleSelectFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MultipleSelectFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MultipleSelectFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MultipleSelectFieldField> mapFromJson(dynamic json) {
    final map = <String, MultipleSelectFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MultipleSelectFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MultipleSelectFieldField-objects as value to a dart map
  static Map<String, List<MultipleSelectFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MultipleSelectFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MultipleSelectFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
