...
class HeaderElementElement {
  /// Returns a new [HeaderElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeaderElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [HeaderElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeaderElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeaderElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeaderElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeaderElementElement(
  ...
  static List<HeaderElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeaderElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeaderElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeaderElementElement> mapFromJson(dynamic json) {
    final map = <String, HeaderElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeaderElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeaderElementElement-objects as value to a dart map
  static Map<String, List<HeaderElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeaderElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeaderElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
