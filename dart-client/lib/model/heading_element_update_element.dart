...
class HeadingElementUpdateElement {
  /// Returns a new [HeadingElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeadingElementUpdateElement &&
  ...
  /// Returns a new [HeadingElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeadingElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeadingElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeadingElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeadingElementUpdateElement(
  ...
  static List<HeadingElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeadingElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeadingElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeadingElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, HeadingElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeadingElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeadingElementUpdateElement-objects as value to a dart map
  static Map<String, List<HeadingElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeadingElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeadingElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
