...
class FooterElementPublicElement {
  /// Returns a new [FooterElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FooterElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [FooterElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FooterElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FooterElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FooterElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FooterElementPublicElement(
  ...
  static List<FooterElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FooterElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FooterElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FooterElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, FooterElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FooterElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FooterElementPublicElement-objects as value to a dart map
  static Map<String, List<FooterElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FooterElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FooterElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
