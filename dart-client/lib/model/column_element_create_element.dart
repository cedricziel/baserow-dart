...
class ColumnElementCreateElement {
  /// Returns a new [ColumnElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ColumnElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [ColumnElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ColumnElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ColumnElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ColumnElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ColumnElementCreateElement(
  ...
  static List<ColumnElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ColumnElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ColumnElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ColumnElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, ColumnElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ColumnElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ColumnElementCreateElement-objects as value to a dart map
  static Map<String, List<ColumnElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ColumnElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ColumnElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
