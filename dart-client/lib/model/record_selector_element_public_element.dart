...
class RecordSelectorElementPublicElement {
  /// Returns a new [RecordSelectorElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RecordSelectorElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [RecordSelectorElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RecordSelectorElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RecordSelectorElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RecordSelectorElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RecordSelectorElementPublicElement(
  ...
  static List<RecordSelectorElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RecordSelectorElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RecordSelectorElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RecordSelectorElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, RecordSelectorElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RecordSelectorElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RecordSelectorElementPublicElement-objects as value to a dart map
  static Map<String, List<RecordSelectorElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RecordSelectorElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RecordSelectorElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
