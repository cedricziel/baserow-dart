...
class LinkElementUpdateElement {
  /// Returns a new [LinkElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LinkElementUpdateElement &&
  ...
  /// Returns a new [LinkElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LinkElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LinkElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LinkElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LinkElementUpdateElement(
  ...
  static List<LinkElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LinkElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LinkElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LinkElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, LinkElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LinkElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LinkElementUpdateElement-objects as value to a dart map
  static Map<String, List<LinkElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LinkElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LinkElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
