...
class CreatedOnFieldField {
  /// Returns a new [CreatedOnFieldField] instance.
  CreatedOnFieldField({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreatedOnFieldField &&
    other.id == id &&
  ...
  /// Returns a new [CreatedOnFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreatedOnFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreatedOnFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreatedOnFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CreatedOnFieldField(
  ...
  static List<CreatedOnFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreatedOnFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreatedOnFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreatedOnFieldField> mapFromJson(dynamic json) {
    final map = <String, CreatedOnFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreatedOnFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreatedOnFieldField-objects as value to a dart map
  static Map<String, List<CreatedOnFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreatedOnFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreatedOnFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
