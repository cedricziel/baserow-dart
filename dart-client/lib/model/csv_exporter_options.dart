...
class CsvExporterOptions {
  /// Returns a new [CsvExporterOptions] instance.
  CsvExporterOptions({
    this.viewId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CsvExporterOptions &&
    other.viewId == viewId &&
  ...
  @override
  String toString() => 'CsvExporterOptions[viewId=$viewId, exporterType=$exporterType, exportCharset=$exportCharset, csvColumnSeparator=$csvColumnSeparator, csvIncludeHeader=$csvIncludeHeader]';
  ...
  /// Returns a new [CsvExporterOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CsvExporterOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CsvExporterOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CsvExporterOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CsvExporterOptions(
  ...
  static List<CsvExporterOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CsvExporterOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CsvExporterOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CsvExporterOptions> mapFromJson(dynamic json) {
    final map = <String, CsvExporterOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CsvExporterOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CsvExporterOptions-objects as value to a dart map
  static Map<String, List<CsvExporterOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CsvExporterOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CsvExporterOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
