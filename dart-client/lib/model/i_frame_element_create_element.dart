...
class IFrameElementCreateElement {
  /// Returns a new [IFrameElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IFrameElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [IFrameElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IFrameElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IFrameElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IFrameElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IFrameElementCreateElement(
  ...
  static List<IFrameElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IFrameElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IFrameElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IFrameElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, IFrameElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IFrameElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IFrameElementCreateElement-objects as value to a dart map
  static Map<String, List<IFrameElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IFrameElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IFrameElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
