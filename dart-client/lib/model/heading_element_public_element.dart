...
class HeadingElementPublicElement {
  /// Returns a new [HeadingElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeadingElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [HeadingElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeadingElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeadingElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeadingElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeadingElementPublicElement(
  ...
  static List<HeadingElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeadingElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeadingElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeadingElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, HeadingElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeadingElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeadingElementPublicElement-objects as value to a dart map
  static Map<String, List<HeadingElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeadingElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeadingElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
