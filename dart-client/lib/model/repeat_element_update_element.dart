...
class RepeatElementUpdateElement {
  /// Returns a new [RepeatElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RepeatElementUpdateElement &&
  ...
  /// Returns a new [RepeatElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RepeatElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RepeatElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RepeatElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RepeatElementUpdateElement(
  ...
  static List<RepeatElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RepeatElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RepeatElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RepeatElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, RepeatElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RepeatElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RepeatElementUpdateElement-objects as value to a dart map
  static Map<String, List<RepeatElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RepeatElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RepeatElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
