...
class DateFieldField {
  /// Returns a new [DateFieldField] instance.
  DateFieldField({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DateFieldField &&
    other.id == id &&
  ...
  /// Returns a new [DateFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DateFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DateFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DateFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DateFieldField(
  ...
  static List<DateFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DateFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DateFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DateFieldField> mapFromJson(dynamic json) {
    final map = <String, DateFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DateFieldField-objects as value to a dart map
  static Map<String, List<DateFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DateFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DateFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
