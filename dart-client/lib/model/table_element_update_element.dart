...
class TableElementUpdateElement {
  /// Returns a new [TableElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TableElementUpdateElement &&
  ...
  /// Returns a new [TableElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TableElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TableElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TableElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TableElementUpdateElement(
  ...
  static List<TableElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TableElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TableElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TableElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, TableElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TableElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TableElementUpdateElement-objects as value to a dart map
  static Map<String, List<TableElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TableElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TableElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
