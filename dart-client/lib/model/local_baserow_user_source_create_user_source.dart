...
class LocalBaserowUserSourceCreateUserSource {
  /// Returns a new [LocalBaserowUserSourceCreateUserSource] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LocalBaserowUserSourceCreateUserSource &&
  ...
  @override
  String toString() => 'LocalBaserowUserSourceCreateUserSource[beforeId=$beforeId, type=$type, name=$name, integrationId=$integrationId, authProviders=$authProviders, tableId=$tableId, emailFieldId=$emailFieldId, nameFieldId=$nameFieldId, roleFieldId=$roleFieldId]';
  ...
  /// Returns a new [LocalBaserowUserSourceCreateUserSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LocalBaserowUserSourceCreateUserSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LocalBaserowUserSourceCreateUserSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LocalBaserowUserSourceCreateUserSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LocalBaserowUserSourceCreateUserSource(
  ...
  static List<LocalBaserowUserSourceCreateUserSource> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LocalBaserowUserSourceCreateUserSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LocalBaserowUserSourceCreateUserSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LocalBaserowUserSourceCreateUserSource> mapFromJson(dynamic json) {
    final map = <String, LocalBaserowUserSourceCreateUserSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LocalBaserowUserSourceCreateUserSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LocalBaserowUserSourceCreateUserSource-objects as value to a dart map
  static Map<String, List<LocalBaserowUserSourceCreateUserSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LocalBaserowUserSourceCreateUserSource>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LocalBaserowUserSourceCreateUserSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
