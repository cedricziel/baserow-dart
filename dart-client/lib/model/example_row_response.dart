...
class ExampleRowResponse {
  /// Returns a new [ExampleRowResponse] instance.
  ExampleRowResponse({
    required this.id,
    this.order,
    this.field1,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExampleRowResponse &&
    other.id == id &&
    other.order == order &&
    other.field1 == field1 &&
    other.field2 == field2 &&
  ...
  @override
  String toString() => 'ExampleRowResponse[id=$id, order=$order, field1=$field1, field2=$field2, field3=$field3, field4=$field4, field5=$field5, field6=$field6, field7=$field7, field8=$field8, field9=$field9, field10=$field10, field11=$field11, field12=$field12, field13=$field13, field14=$field14, field15=$field15, field16=$field16, field17=$field17, field18=$field18, field19=$field19, field20=$field20, field21=$field21, field22=$field22, field23=$field23, field24=$field24, field25=$field25, field26=$field26, field27=$field27]';
  ...
  /// Returns a new [ExampleRowResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExampleRowResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExampleRowResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExampleRowResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ExampleRowResponse(
  ...
  static List<ExampleRowResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExampleRowResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExampleRowResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExampleRowResponse> mapFromJson(dynamic json) {
    final map = <String, ExampleRowResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExampleRowResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExampleRowResponse-objects as value to a dart map
  static Map<String, List<ExampleRowResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExampleRowResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExampleRowResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
