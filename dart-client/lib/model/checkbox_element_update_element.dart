...
class CheckboxElementUpdateElement {
  /// Returns a new [CheckboxElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CheckboxElementUpdateElement &&
  ...
  /// Returns a new [CheckboxElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CheckboxElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CheckboxElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CheckboxElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CheckboxElementUpdateElement(
  ...
  static List<CheckboxElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckboxElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckboxElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CheckboxElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, CheckboxElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CheckboxElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CheckboxElementUpdateElement-objects as value to a dart map
  static Map<String, List<CheckboxElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CheckboxElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CheckboxElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
