...
class CheckboxElementCreateElement {
  /// Returns a new [CheckboxElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CheckboxElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [CheckboxElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CheckboxElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CheckboxElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CheckboxElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CheckboxElementCreateElement(
  ...
  static List<CheckboxElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckboxElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckboxElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CheckboxElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, CheckboxElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CheckboxElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CheckboxElementCreateElement-objects as value to a dart map
  static Map<String, List<CheckboxElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CheckboxElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CheckboxElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
