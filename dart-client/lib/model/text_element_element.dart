...
class TextElementElement {
  /// Returns a new [TextElementElement] instance.
  TextElementElement({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TextElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [TextElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TextElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TextElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TextElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TextElementElement(
  ...
  static List<TextElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TextElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TextElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TextElementElement> mapFromJson(dynamic json) {
    final map = <String, TextElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TextElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TextElementElement-objects as value to a dart map
  static Map<String, List<TextElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TextElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TextElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
