...
class InputTextElementCreateElement {
  /// Returns a new [InputTextElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InputTextElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [InputTextElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InputTextElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InputTextElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InputTextElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return InputTextElementCreateElement(
  ...
  static List<InputTextElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InputTextElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InputTextElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InputTextElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, InputTextElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InputTextElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InputTextElementCreateElement-objects as value to a dart map
  static Map<String, List<InputTextElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InputTextElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InputTextElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
