...
class PatchedUpdateViewFilter {
  /// Returns a new [PatchedUpdateViewFilter] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PatchedUpdateViewFilter &&
    other.field == field &&
    other.type == type &&
    other.value == value;
  ...
  @override
  String toString() => 'PatchedUpdateViewFilter[field=$field, type=$type, value=$value]';
  ...
  /// Returns a new [PatchedUpdateViewFilter] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PatchedUpdateViewFilter? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PatchedUpdateViewFilter[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PatchedUpdateViewFilter[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PatchedUpdateViewFilter(
  ...
  static List<PatchedUpdateViewFilter> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PatchedUpdateViewFilter>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PatchedUpdateViewFilter.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PatchedUpdateViewFilter> mapFromJson(dynamic json) {
    final map = <String, PatchedUpdateViewFilter>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PatchedUpdateViewFilter.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PatchedUpdateViewFilter-objects as value to a dart map
  static Map<String, List<PatchedUpdateViewFilter>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PatchedUpdateViewFilter>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PatchedUpdateViewFilter.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
