...
class TextElementUpdateElement {
  /// Returns a new [TextElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TextElementUpdateElement &&
  ...
  /// Returns a new [TextElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TextElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TextElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TextElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TextElementUpdateElement(
  ...
  static List<TextElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TextElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TextElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TextElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, TextElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TextElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TextElementUpdateElement-objects as value to a dart map
  static Map<String, List<TextElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TextElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TextElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
