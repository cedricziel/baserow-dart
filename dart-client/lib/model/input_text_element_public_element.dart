...
class InputTextElementPublicElement {
  /// Returns a new [InputTextElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InputTextElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [InputTextElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InputTextElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InputTextElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InputTextElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return InputTextElementPublicElement(
  ...
  static List<InputTextElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InputTextElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InputTextElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InputTextElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, InputTextElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InputTextElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InputTextElementPublicElement-objects as value to a dart map
  static Map<String, List<InputTextElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InputTextElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InputTextElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
