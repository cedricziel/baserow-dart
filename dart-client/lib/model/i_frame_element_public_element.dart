...
class IFrameElementPublicElement {
  /// Returns a new [IFrameElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IFrameElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [IFrameElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IFrameElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IFrameElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IFrameElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IFrameElementPublicElement(
  ...
  static List<IFrameElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IFrameElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IFrameElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IFrameElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, IFrameElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IFrameElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IFrameElementPublicElement-objects as value to a dart map
  static Map<String, List<IFrameElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IFrameElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IFrameElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
