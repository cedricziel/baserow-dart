...
class FooterElementCreateElement {
  /// Returns a new [FooterElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FooterElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [FooterElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FooterElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FooterElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FooterElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FooterElementCreateElement(
  ...
  static List<FooterElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FooterElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FooterElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FooterElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, FooterElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FooterElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FooterElementCreateElement-objects as value to a dart map
  static Map<String, List<FooterElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FooterElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FooterElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
