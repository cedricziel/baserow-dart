...
class ElementTypeCreateElement {
  /// Returns a new [ElementTypeCreateElement] instance.
  ElementTypeCreateElement({
    required this.order,
    this.beforeId,
    required this.type,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ElementTypeCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [ElementTypeCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ElementTypeCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ElementTypeCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ElementTypeCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ElementTypeCreateElement(
  ...
  static List<ElementTypeCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ElementTypeCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ElementTypeCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ElementTypeCreateElement> mapFromJson(dynamic json) {
    final map = <String, ElementTypeCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ElementTypeCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ElementTypeCreateElement-objects as value to a dart map
  static Map<String, List<ElementTypeCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ElementTypeCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ElementTypeCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
