...
class ButtonElementPublicElement {
  /// Returns a new [ButtonElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ButtonElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ButtonElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ButtonElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ButtonElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ButtonElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ButtonElementPublicElement(
  ...
  static List<ButtonElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ButtonElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ButtonElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ButtonElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, ButtonElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ButtonElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ButtonElementPublicElement-objects as value to a dart map
  static Map<String, List<ButtonElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ButtonElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ButtonElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
