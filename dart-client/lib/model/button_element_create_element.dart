...
class ButtonElementCreateElement {
  /// Returns a new [ButtonElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ButtonElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [ButtonElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ButtonElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ButtonElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ButtonElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ButtonElementCreateElement(
  ...
  static List<ButtonElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ButtonElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ButtonElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ButtonElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, ButtonElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ButtonElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ButtonElementCreateElement-objects as value to a dart map
  static Map<String, List<ButtonElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ButtonElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ButtonElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
