...
class LongTextFieldFieldSerializerWithRelatedFields {
  /// Returns a new [LongTextFieldFieldSerializerWithRelatedFields] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LongTextFieldFieldSerializerWithRelatedFields &&
    other.id == id &&
  ...
  @override
  String toString() => 'LongTextFieldFieldSerializerWithRelatedFields[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description, relatedFields=$relatedFields, longTextEnableRichText=$longTextEnableRichText]';
  ...
  /// Returns a new [LongTextFieldFieldSerializerWithRelatedFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LongTextFieldFieldSerializerWithRelatedFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LongTextFieldFieldSerializerWithRelatedFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LongTextFieldFieldSerializerWithRelatedFields[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LongTextFieldFieldSerializerWithRelatedFields(
  ...
  static List<LongTextFieldFieldSerializerWithRelatedFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LongTextFieldFieldSerializerWithRelatedFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LongTextFieldFieldSerializerWithRelatedFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LongTextFieldFieldSerializerWithRelatedFields> mapFromJson(dynamic json) {
    final map = <String, LongTextFieldFieldSerializerWithRelatedFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LongTextFieldFieldSerializerWithRelatedFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LongTextFieldFieldSerializerWithRelatedFields-objects as value to a dart map
  static Map<String, List<LongTextFieldFieldSerializerWithRelatedFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LongTextFieldFieldSerializerWithRelatedFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LongTextFieldFieldSerializerWithRelatedFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
