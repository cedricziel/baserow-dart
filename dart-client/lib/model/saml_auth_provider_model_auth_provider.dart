...
class SamlAuthProviderModelAuthProvider {
  /// Returns a new [SamlAuthProviderModelAuthProvider] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SamlAuthProviderModelAuthProvider &&
    other.id == id &&
    other.type == type &&
    other.domain == domain &&
  ...
  @override
  String toString() => 'SamlAuthProviderModelAuthProvider[id=$id, type=$type, domain=$domain, enabled=$enabled, metadata=$metadata, isVerified=$isVerified, emailAttrKey=$emailAttrKey, firstNameAttrKey=$firstNameAttrKey, lastNameAttrKey=$lastNameAttrKey]';
  ...
  /// Returns a new [SamlAuthProviderModelAuthProvider] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SamlAuthProviderModelAuthProvider? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SamlAuthProviderModelAuthProvider[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SamlAuthProviderModelAuthProvider[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SamlAuthProviderModelAuthProvider(
  ...
  static List<SamlAuthProviderModelAuthProvider> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SamlAuthProviderModelAuthProvider>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SamlAuthProviderModelAuthProvider.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SamlAuthProviderModelAuthProvider> mapFromJson(dynamic json) {
    final map = <String, SamlAuthProviderModelAuthProvider>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SamlAuthProviderModelAuthProvider.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SamlAuthProviderModelAuthProvider-objects as value to a dart map
  static Map<String, List<SamlAuthProviderModelAuthProvider>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SamlAuthProviderModelAuthProvider>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SamlAuthProviderModelAuthProvider.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
