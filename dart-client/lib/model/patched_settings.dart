...
class PatchedSettings {
  /// Returns a new [PatchedSettings] instance.
  PatchedSettings({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PatchedSettings &&
  ...
  /// Returns a new [PatchedSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PatchedSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PatchedSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PatchedSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PatchedSettings> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PatchedSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PatchedSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PatchedSettings> mapFromJson(dynamic json) {
    final map = <String, PatchedSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PatchedSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PatchedSettings-objects as value to a dart map
  static Map<String, List<PatchedSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PatchedSettings>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PatchedSettings.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
