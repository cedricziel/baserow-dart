...
class CheckboxElementPublicElement {
  /// Returns a new [CheckboxElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CheckboxElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [CheckboxElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CheckboxElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CheckboxElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CheckboxElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CheckboxElementPublicElement(
  ...
  static List<CheckboxElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckboxElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckboxElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CheckboxElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, CheckboxElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CheckboxElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CheckboxElementPublicElement-objects as value to a dart map
  static Map<String, List<CheckboxElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CheckboxElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CheckboxElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
