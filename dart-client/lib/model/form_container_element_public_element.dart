...
class FormContainerElementPublicElement {
  /// Returns a new [FormContainerElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FormContainerElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [FormContainerElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FormContainerElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FormContainerElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FormContainerElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FormContainerElementPublicElement(
  ...
  static List<FormContainerElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FormContainerElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FormContainerElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FormContainerElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, FormContainerElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FormContainerElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FormContainerElementPublicElement-objects as value to a dart map
  static Map<String, List<FormContainerElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FormContainerElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FormContainerElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
