...
class LinkElementPublicElement {
  /// Returns a new [LinkElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LinkElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [LinkElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LinkElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LinkElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LinkElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LinkElementPublicElement(
        ...
        styles: ButtonLinkConfigBlock.fromJson(json[r'styles']),
  ...
  static List<LinkElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LinkElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LinkElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LinkElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, LinkElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LinkElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LinkElementPublicElement-objects as value to a dart map
  static Map<String, List<LinkElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LinkElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LinkElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
