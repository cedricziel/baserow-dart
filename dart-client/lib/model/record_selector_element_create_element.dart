...
class RecordSelectorElementCreateElement {
  /// Returns a new [RecordSelectorElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RecordSelectorElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [RecordSelectorElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RecordSelectorElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RecordSelectorElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RecordSelectorElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RecordSelectorElementCreateElement(
  ...
  static List<RecordSelectorElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RecordSelectorElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RecordSelectorElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RecordSelectorElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, RecordSelectorElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RecordSelectorElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RecordSelectorElementCreateElement-objects as value to a dart map
  static Map<String, List<RecordSelectorElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RecordSelectorElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RecordSelectorElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
