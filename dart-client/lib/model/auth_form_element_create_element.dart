...
class AuthFormElementCreateElement {
  /// Returns a new [AuthFormElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthFormElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [AuthFormElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthFormElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AuthFormElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AuthFormElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AuthFormElementCreateElement(
  ...
  static List<AuthFormElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthFormElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthFormElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthFormElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, AuthFormElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthFormElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthFormElementCreateElement-objects as value to a dart map
  static Map<String, List<AuthFormElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthFormElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AuthFormElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
