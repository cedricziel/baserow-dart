...
class HeaderElementCreateElement {
  /// Returns a new [HeaderElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeaderElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [HeaderElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeaderElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeaderElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeaderElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeaderElementCreateElement(
  ...
  static List<HeaderElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeaderElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeaderElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeaderElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, HeaderElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeaderElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeaderElementCreateElement-objects as value to a dart map
  static Map<String, List<HeaderElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeaderElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeaderElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
