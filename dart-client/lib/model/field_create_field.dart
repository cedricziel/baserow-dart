...
class FieldCreateField {
  /// Returns a new [FieldCreateField] instance.
  FieldCreateField({
    required this.name,
    required this.type,
    this.description,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FieldCreateField &&
    other.name == name &&
    other.type == type &&
  ...
  /// Returns a new [FieldCreateField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FieldCreateField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FieldCreateField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FieldCreateField[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FieldCreateField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FieldCreateField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FieldCreateField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FieldCreateField> mapFromJson(dynamic json) {
    final map = <String, FieldCreateField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FieldCreateField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FieldCreateField-objects as value to a dart map
  static Map<String, List<FieldCreateField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FieldCreateField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FieldCreateField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
