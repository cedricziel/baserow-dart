...
class ImageElementPublicElement {
  /// Returns a new [ImageElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ImageElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ImageElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ImageElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ImageElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ImageElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ImageElementPublicElement(
  ...
  static List<ImageElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ImageElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ImageElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ImageElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, ImageElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ImageElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ImageElementPublicElement-objects as value to a dart map
  static Map<String, List<ImageElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ImageElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ImageElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
