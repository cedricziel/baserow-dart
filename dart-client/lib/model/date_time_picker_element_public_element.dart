...
class DateTimePickerElementPublicElement {
  /// Returns a new [DateTimePickerElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DateTimePickerElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [DateTimePickerElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DateTimePickerElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DateTimePickerElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DateTimePickerElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DateTimePickerElementPublicElement(
  ...
  static List<DateTimePickerElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DateTimePickerElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DateTimePickerElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DateTimePickerElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, DateTimePickerElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateTimePickerElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DateTimePickerElementPublicElement-objects as value to a dart map
  static Map<String, List<DateTimePickerElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DateTimePickerElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DateTimePickerElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
