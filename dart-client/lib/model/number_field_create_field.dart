...
class NumberFieldCreateField {
  /// Returns a new [NumberFieldCreateField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NumberFieldCreateField &&
    other.name == name &&
    other.type == type &&
  ...
  @override
  String toString() => 'NumberFieldCreateField[name=$name, type=$type, description=$description, numberDecimalPlaces=$numberDecimalPlaces, numberNegative=$numberNegative, numberPrefix=$numberPrefix, numberSuffix=$numberSuffix, numberSeparator=$numberSeparator]';
  ...
  /// Returns a new [NumberFieldCreateField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NumberFieldCreateField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NumberFieldCreateField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NumberFieldCreateField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return NumberFieldCreateField(
  ...
  static List<NumberFieldCreateField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NumberFieldCreateField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NumberFieldCreateField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NumberFieldCreateField> mapFromJson(dynamic json) {
    final map = <String, NumberFieldCreateField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NumberFieldCreateField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NumberFieldCreateField-objects as value to a dart map
  static Map<String, List<NumberFieldCreateField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NumberFieldCreateField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NumberFieldCreateField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
