...
class TableElementCreateElement {
  /// Returns a new [TableElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TableElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [TableElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TableElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TableElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TableElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TableElementCreateElement(
  ...
  static List<TableElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TableElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TableElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TableElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, TableElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TableElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TableElementCreateElement-objects as value to a dart map
  static Map<String, List<TableElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TableElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TableElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
