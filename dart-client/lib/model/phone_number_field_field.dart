...
class PhoneNumberFieldField {
  /// Returns a new [PhoneNumberFieldField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PhoneNumberFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'PhoneNumberFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description]';
  ...
  /// Returns a new [PhoneNumberFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PhoneNumberFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PhoneNumberFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PhoneNumberFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PhoneNumberFieldField(
  ...
  static List<PhoneNumberFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PhoneNumberFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PhoneNumberFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PhoneNumberFieldField> mapFromJson(dynamic json) {
    final map = <String, PhoneNumberFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PhoneNumberFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PhoneNumberFieldField-objects as value to a dart map
  static Map<String, List<PhoneNumberFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PhoneNumberFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PhoneNumberFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
