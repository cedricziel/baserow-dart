...
class ColumnElementPublicElement {
  /// Returns a new [ColumnElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ColumnElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ColumnElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ColumnElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ColumnElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ColumnElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ColumnElementPublicElement(
  ...
  static List<ColumnElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ColumnElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ColumnElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ColumnElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, ColumnElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ColumnElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ColumnElementPublicElement-objects as value to a dart map
  static Map<String, List<ColumnElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ColumnElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ColumnElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
