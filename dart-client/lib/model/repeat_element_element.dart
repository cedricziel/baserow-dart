...
class RepeatElementElement {
  /// Returns a new [RepeatElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RepeatElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [RepeatElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RepeatElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RepeatElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RepeatElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RepeatElementElement(
  ...
  static List<RepeatElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RepeatElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RepeatElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RepeatElementElement> mapFromJson(dynamic json) {
    final map = <String, RepeatElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RepeatElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RepeatElementElement-objects as value to a dart map
  static Map<String, List<RepeatElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RepeatElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RepeatElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
