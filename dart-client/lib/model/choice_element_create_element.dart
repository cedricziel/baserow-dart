...
class ChoiceElementCreateElement {
  /// Returns a new [ChoiceElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChoiceElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [ChoiceElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ChoiceElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChoiceElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChoiceElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ChoiceElementCreateElement(
  ...
  static List<ChoiceElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChoiceElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChoiceElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ChoiceElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, ChoiceElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChoiceElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ChoiceElementCreateElement-objects as value to a dart map
  static Map<String, List<ChoiceElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChoiceElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ChoiceElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
