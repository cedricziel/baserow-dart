...
class AutonumberFieldField {
  /// Returns a new [AutonumberFieldField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AutonumberFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'AutonumberFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description]';
  ...
  /// Returns a new [AutonumberFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AutonumberFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AutonumberFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AutonumberFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AutonumberFieldField(
  ...
  static List<AutonumberFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AutonumberFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AutonumberFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AutonumberFieldField> mapFromJson(dynamic json) {
    final map = <String, AutonumberFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AutonumberFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AutonumberFieldField-objects as value to a dart map
  static Map<String, List<AutonumberFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AutonumberFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AutonumberFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
