...
class TableElementPublicElement {
  /// Returns a new [TableElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TableElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [TableElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TableElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TableElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TableElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TableElementPublicElement(
  ...
  static List<TableElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TableElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TableElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TableElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, TableElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TableElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TableElementPublicElement-objects as value to a dart map
  static Map<String, List<TableElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TableElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TableElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
