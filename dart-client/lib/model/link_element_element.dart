...
class LinkElementElement {
  /// Returns a new [LinkElementElement] instance.
  LinkElementElement({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LinkElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [LinkElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LinkElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LinkElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LinkElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LinkElementElement(
  ...
  static List<LinkElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LinkElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LinkElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LinkElementElement> mapFromJson(dynamic json) {
    final map = <String, LinkElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LinkElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LinkElementElement-objects as value to a dart map
  static Map<String, List<LinkElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LinkElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LinkElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
