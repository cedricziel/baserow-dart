...
class LookupFieldField {
  /// Returns a new [LookupFieldField] instance.
  LookupFieldField({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LookupFieldField &&
    other.id == id &&
  ...
  /// Returns a new [LookupFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LookupFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LookupFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LookupFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LookupFieldField(
  ...
  static List<LookupFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LookupFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LookupFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LookupFieldField> mapFromJson(dynamic json) {
    final map = <String, LookupFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LookupFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LookupFieldField-objects as value to a dart map
  static Map<String, List<LookupFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LookupFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LookupFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
