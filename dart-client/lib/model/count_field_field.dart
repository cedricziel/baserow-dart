...
class CountFieldField {
  /// Returns a new [CountFieldField] instance.
  CountFieldField({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CountFieldField &&
    other.id == id &&
  ...
  /// Returns a new [CountFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CountFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CountFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CountFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CountFieldField(
  ...
  static List<CountFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CountFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CountFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CountFieldField> mapFromJson(dynamic json) {
    final map = <String, CountFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CountFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CountFieldField-objects as value to a dart map
  static Map<String, List<CountFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CountFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CountFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
