...
class AuthFormElementUpdateElement {
  /// Returns a new [AuthFormElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthFormElementUpdateElement &&
  ...
  /// Returns a new [AuthFormElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthFormElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AuthFormElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AuthFormElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AuthFormElementUpdateElement(
  ...
  static List<AuthFormElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthFormElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthFormElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthFormElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, AuthFormElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthFormElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthFormElementUpdateElement-objects as value to a dart map
  static Map<String, List<AuthFormElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthFormElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AuthFormElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
