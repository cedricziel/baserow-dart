...
class ColumnElementUpdateElement {
  /// Returns a new [ColumnElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ColumnElementUpdateElement &&
  ...
  /// Returns a new [ColumnElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ColumnElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ColumnElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ColumnElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ColumnElementUpdateElement(
  ...
  static List<ColumnElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ColumnElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ColumnElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ColumnElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, ColumnElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ColumnElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ColumnElementUpdateElement-objects as value to a dart map
  static Map<String, List<ColumnElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ColumnElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ColumnElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
