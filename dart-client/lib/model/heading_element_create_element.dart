...
class HeadingElementCreateElement {
  /// Returns a new [HeadingElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeadingElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [HeadingElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeadingElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeadingElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeadingElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeadingElementCreateElement(
  ...
  static List<HeadingElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeadingElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeadingElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeadingElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, HeadingElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeadingElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeadingElementCreateElement-objects as value to a dart map
  static Map<String, List<HeadingElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeadingElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeadingElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
