...
class CountFieldFieldSerializerWithRelatedFields {
  /// Returns a new [CountFieldFieldSerializerWithRelatedFields] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CountFieldFieldSerializerWithRelatedFields &&
    other.id == id &&
  ...
  /// Returns a new [CountFieldFieldSerializerWithRelatedFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CountFieldFieldSerializerWithRelatedFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CountFieldFieldSerializerWithRelatedFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CountFieldFieldSerializerWithRelatedFields[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CountFieldFieldSerializerWithRelatedFields(
  ...
  static List<CountFieldFieldSerializerWithRelatedFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CountFieldFieldSerializerWithRelatedFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CountFieldFieldSerializerWithRelatedFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CountFieldFieldSerializerWithRelatedFields> mapFromJson(dynamic json) {
    final map = <String, CountFieldFieldSerializerWithRelatedFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CountFieldFieldSerializerWithRelatedFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CountFieldFieldSerializerWithRelatedFields-objects as value to a dart map
  static Map<String, List<CountFieldFieldSerializerWithRelatedFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CountFieldFieldSerializerWithRelatedFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CountFieldFieldSerializerWithRelatedFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
