...
class IFrameElementUpdateElement {
  /// Returns a new [IFrameElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IFrameElementUpdateElement &&
  ...
  /// Returns a new [IFrameElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IFrameElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IFrameElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IFrameElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IFrameElementUpdateElement(
  ...
  static List<IFrameElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IFrameElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IFrameElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IFrameElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, IFrameElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IFrameElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IFrameElementUpdateElement-objects as value to a dart map
  static Map<String, List<IFrameElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IFrameElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IFrameElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
