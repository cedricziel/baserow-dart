...
class InputTextElementUpdateElement {
  /// Returns a new [InputTextElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InputTextElementUpdateElement &&
  ...
  /// Returns a new [InputTextElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InputTextElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InputTextElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InputTextElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return InputTextElementUpdateElement(
  ...
  static List<InputTextElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InputTextElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InputTextElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InputTextElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, InputTextElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InputTextElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InputTextElementUpdateElement-objects as value to a dart map
  static Map<String, List<InputTextElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InputTextElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InputTextElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
