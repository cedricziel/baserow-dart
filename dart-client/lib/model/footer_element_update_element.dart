...
class FooterElementUpdateElement {
  /// Returns a new [FooterElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FooterElementUpdateElement &&
  ...
  /// Returns a new [FooterElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FooterElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FooterElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FooterElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FooterElementUpdateElement(
  ...
  static List<FooterElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FooterElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FooterElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FooterElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, FooterElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FooterElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FooterElementUpdateElement-objects as value to a dart map
  static Map<String, List<FooterElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FooterElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FooterElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
