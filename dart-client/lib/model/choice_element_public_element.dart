...
class ChoiceElementPublicElement {
  /// Returns a new [ChoiceElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChoiceElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ChoiceElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ChoiceElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChoiceElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChoiceElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ChoiceElementPublicElement(
  ...
  static List<ChoiceElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChoiceElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChoiceElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ChoiceElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, ChoiceElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChoiceElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ChoiceElementPublicElement-objects as value to a dart map
  static Map<String, List<ChoiceElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChoiceElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ChoiceElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
