...
class BooleanFieldField {
  /// Returns a new [BooleanFieldField] instance.
  BooleanFieldField({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BooleanFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'BooleanFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description]';
  ...
  /// Returns a new [BooleanFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BooleanFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "BooleanFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "BooleanFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return BooleanFieldField(
  ...
  static List<BooleanFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BooleanFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BooleanFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BooleanFieldField> mapFromJson(dynamic json) {
    final map = <String, BooleanFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BooleanFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BooleanFieldField-objects as value to a dart map
  static Map<String, List<BooleanFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BooleanFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BooleanFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
