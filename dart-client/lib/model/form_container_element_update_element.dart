...
class FormContainerElementUpdateElement {
  /// Returns a new [FormContainerElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FormContainerElementUpdateElement &&
  ...
  @override
  String toString() => 'FormContainerElementUpdateElement[visibility=$visibility, styles=$styles, styleBorderTopColor=$styleBorderTopColor, styleBorderTopSize=$styleBorderTopSize, stylePaddingTop=$stylePaddingTop, styleMarginTop=$styleMarginTop, styleBorderBottomColor=$styleBorderBottomColor, styleBorderBottomSize=$styleBorderBottomSize, stylePaddingBottom=$stylePaddingBottom, styleMarginBottom=$styleMarginBottom, styleBorderLeftColor=$styleBorderLeftColor, styleBorderLeftSize=$styleBorderLeftSize, stylePaddingLeft=$stylePaddingLeft, styleMarginLeft=$styleMarginLeft, styleBorderRightColor=$styleBorderRightColor, styleBorderRightSize=$styleBorderRightSize, stylePaddingRight=$stylePaddingRight, styleMarginRight=$styleMarginRight, styleBackground=$styleBackground, styleBackgroundColor=$styleBackgroundColor, styleBackgroundFile=$styleBackgroundFile, styleBackgroundMode=$styleBackgroundMode, styleWidth=$styleWidth, roleType=$roleType, roles=$roles, submitButtonLabel=$submitButtonLabel, resetInitialValuesPostSubmission=$resetInitialValuesPostSubmission]';
  ...
  /// Returns a new [FormContainerElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FormContainerElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FormContainerElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FormContainerElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FormContainerElementUpdateElement(
        visibility: Visibility789Enum.fromJson(json[r'visibility']),
        styles: ButtonConfigBlock.fromJson(json[r'styles']),
  ...
  static List<FormContainerElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FormContainerElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FormContainerElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FormContainerElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, FormContainerElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FormContainerElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FormContainerElementUpdateElement-objects as value to a dart map
  static Map<String, List<FormContainerElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FormContainerElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FormContainerElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
