...
class IntegrationServiceCreateDataSource {
  /// Returns a new [IntegrationServiceCreateDataSource] instance.
  IntegrationServiceCreateDataSource({
    this.type,
    this.name,
    this.pageId,
    this.beforeId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IntegrationServiceCreateDataSource &&
    other.type == type &&
    other.name == name &&
    other.pageId == pageId &&
  ...
  /// Returns a new [IntegrationServiceCreateDataSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IntegrationServiceCreateDataSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IntegrationServiceCreateDataSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IntegrationServiceCreateDataSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IntegrationServiceCreateDataSource(
  ...
  static List<IntegrationServiceCreateDataSource> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IntegrationServiceCreateDataSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IntegrationServiceCreateDataSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IntegrationServiceCreateDataSource> mapFromJson(dynamic json) {
    final map = <String, IntegrationServiceCreateDataSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IntegrationServiceCreateDataSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IntegrationServiceCreateDataSource-objects as value to a dart map
  static Map<String, List<IntegrationServiceCreateDataSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IntegrationServiceCreateDataSource>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IntegrationServiceCreateDataSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
