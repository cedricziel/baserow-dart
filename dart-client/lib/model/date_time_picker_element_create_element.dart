...
class DateTimePickerElementCreateElement {
  /// Returns a new [DateTimePickerElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DateTimePickerElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [DateTimePickerElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DateTimePickerElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DateTimePickerElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DateTimePickerElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DateTimePickerElementCreateElement(
  ...
  static List<DateTimePickerElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DateTimePickerElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DateTimePickerElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DateTimePickerElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, DateTimePickerElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateTimePickerElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DateTimePickerElementCreateElement-objects as value to a dart map
  static Map<String, List<DateTimePickerElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DateTimePickerElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DateTimePickerElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
