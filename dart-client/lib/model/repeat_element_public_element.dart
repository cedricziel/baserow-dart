...
class RepeatElementPublicElement {
  /// Returns a new [RepeatElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RepeatElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [RepeatElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RepeatElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RepeatElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RepeatElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RepeatElementPublicElement(
  ...
  static List<RepeatElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RepeatElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RepeatElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RepeatElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, RepeatElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RepeatElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RepeatElementPublicElement-objects as value to a dart map
  static Map<String, List<RepeatElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RepeatElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RepeatElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
