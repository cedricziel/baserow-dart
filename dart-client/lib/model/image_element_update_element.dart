...
class ImageElementUpdateElement {
  /// Returns a new [ImageElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ImageElementUpdateElement &&
  ...
  /// Returns a new [ImageElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ImageElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ImageElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ImageElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ImageElementUpdateElement(
  ...
  static List<ImageElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ImageElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ImageElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ImageElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, ImageElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ImageElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ImageElementUpdateElement-objects as value to a dart map
  static Map<String, List<ImageElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ImageElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ImageElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
