...
class LinkElementCreateElement {
  /// Returns a new [LinkElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LinkElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [LinkElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LinkElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LinkElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LinkElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LinkElementCreateElement(
  ...
  static List<LinkElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LinkElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LinkElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LinkElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, LinkElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LinkElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LinkElementCreateElement-objects as value to a dart map
  static Map<String, List<LinkElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LinkElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LinkElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
