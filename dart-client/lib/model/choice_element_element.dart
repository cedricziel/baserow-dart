...
class ChoiceElementElement {
  /// Returns a new [ChoiceElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChoiceElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ChoiceElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ChoiceElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChoiceElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChoiceElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ChoiceElementElement(
  ...
  static List<ChoiceElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChoiceElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChoiceElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ChoiceElementElement> mapFromJson(dynamic json) {
    final map = <String, ChoiceElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChoiceElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ChoiceElementElement-objects as value to a dart map
  static Map<String, List<ChoiceElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChoiceElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ChoiceElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
