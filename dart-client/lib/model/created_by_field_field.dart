...
class CreatedByFieldField {
  /// Returns a new [CreatedByFieldField] instance.
  CreatedByFieldField({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreatedByFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'CreatedByFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description]';
  ...
  /// Returns a new [CreatedByFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreatedByFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreatedByFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreatedByFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CreatedByFieldField(
  ...
  static List<CreatedByFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreatedByFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreatedByFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreatedByFieldField> mapFromJson(dynamic json) {
    final map = <String, CreatedByFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreatedByFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreatedByFieldField-objects as value to a dart map
  static Map<String, List<CreatedByFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreatedByFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreatedByFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
