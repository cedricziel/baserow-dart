...
class ExcelExporterOptions {
  /// Returns a new [ExcelExporterOptions] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExcelExporterOptions &&
    other.viewId == viewId &&
  ...
  @override
  String toString() => 'ExcelExporterOptions[viewId=$viewId, exporterType=$exporterType, exportCharset=$exportCharset, excelIncludeHeader=$excelIncludeHeader]';
  ...
  /// Returns a new [ExcelExporterOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExcelExporterOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExcelExporterOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExcelExporterOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ExcelExporterOptions(
  ...
  static List<ExcelExporterOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExcelExporterOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExcelExporterOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExcelExporterOptions> mapFromJson(dynamic json) {
    final map = <String, ExcelExporterOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExcelExporterOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExcelExporterOptions-objects as value to a dart map
  static Map<String, List<ExcelExporterOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExcelExporterOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExcelExporterOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
