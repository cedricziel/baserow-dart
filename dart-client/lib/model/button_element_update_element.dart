...
class ButtonElementUpdateElement {
  /// Returns a new [ButtonElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ButtonElementUpdateElement &&
  ...
  /// Returns a new [ButtonElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ButtonElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ButtonElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ButtonElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ButtonElementUpdateElement(
  ...
  static List<ButtonElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ButtonElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ButtonElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ButtonElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, ButtonElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ButtonElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ButtonElementUpdateElement-objects as value to a dart map
  static Map<String, List<ButtonElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ButtonElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ButtonElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
