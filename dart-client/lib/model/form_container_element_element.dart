...
class FormContainerElementElement {
  /// Returns a new [FormContainerElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FormContainerElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [FormContainerElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FormContainerElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FormContainerElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FormContainerElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FormContainerElementElement(
  ...
  static List<FormContainerElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FormContainerElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FormContainerElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FormContainerElementElement> mapFromJson(dynamic json) {
    final map = <String, FormContainerElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FormContainerElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FormContainerElementElement-objects as value to a dart map
  static Map<String, List<FormContainerElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FormContainerElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FormContainerElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
