...
class HeadingElementElement {
  /// Returns a new [HeadingElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeadingElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [HeadingElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeadingElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeadingElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeadingElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeadingElementElement(
  ...
  static List<HeadingElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeadingElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeadingElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeadingElementElement> mapFromJson(dynamic json) {
    final map = <String, HeadingElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeadingElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeadingElementElement-objects as value to a dart map
  static Map<String, List<HeadingElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeadingElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeadingElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
