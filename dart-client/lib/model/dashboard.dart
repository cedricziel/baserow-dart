...
class Dashboard {
  ...
  Dashboard({
    this.workspaceInvitations = const [],
  });

  List<UserWorkspaceInvitation> workspaceInvitations;

  @override
  bool operator ==(Object other) => identical(this, other) || other is Dashboard &&
    _deepEquality.equals(other.workspaceInvitations, workspaceInvitations);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (workspaceInvitations.hashCode);

  @override
  String toString() => 'Dashboard[workspaceInvitations=$workspaceInvitations]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'workspace_invitations'] = this.workspaceInvitations;
    return json;
  }
  ...
  static Dashboard? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Dashboard(
        workspaceInvitations: UserWorkspaceInvitation.listFromJson(json[r'workspace_invitations']),
      );
    }
    return null;
  }
