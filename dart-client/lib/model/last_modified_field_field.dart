...
class LastModifiedFieldField {
  /// Returns a new [LastModifiedFieldField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LastModifiedFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'LastModifiedFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description, dateFormat=$dateFormat, dateIncludeTime=$dateIncludeTime, dateTimeFormat=$dateTimeFormat, dateShowTzinfo=$dateShowTzinfo, dateForceTimezone=$dateForceTimezone]';
  ...
  /// Returns a new [LastModifiedFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LastModifiedFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LastModifiedFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LastModifiedFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LastModifiedFieldField(
  ...
  static List<LastModifiedFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LastModifiedFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LastModifiedFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LastModifiedFieldField> mapFromJson(dynamic json) {
    final map = <String, LastModifiedFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LastModifiedFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LastModifiedFieldField-objects as value to a dart map
  static Map<String, List<LastModifiedFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LastModifiedFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LastModifiedFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
