...
class RollupFieldCreateField {
  /// Returns a new [RollupFieldCreateField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RollupFieldCreateField &&
    other.name == name &&
    other.type == type &&
  ...
  /// Returns a new [RollupFieldCreateField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RollupFieldCreateField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RollupFieldCreateField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RollupFieldCreateField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RollupFieldCreateField(
  ...
  static List<RollupFieldCreateField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RollupFieldCreateField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RollupFieldCreateField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RollupFieldCreateField> mapFromJson(dynamic json) {
    final map = <String, RollupFieldCreateField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RollupFieldCreateField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RollupFieldCreateField-objects as value to a dart map
  static Map<String, List<RollupFieldCreateField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RollupFieldCreateField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RollupFieldCreateField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
