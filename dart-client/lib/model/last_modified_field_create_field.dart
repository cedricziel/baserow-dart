...
class LastModifiedFieldCreateField {
  /// Returns a new [LastModifiedFieldCreateField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LastModifiedFieldCreateField &&
    other.name == name &&
    other.type == type &&
  ...
  @override
  String toString() => 'LastModifiedFieldCreateField[name=$name, type=$type, description=$description, dateFormat=$dateFormat, dateIncludeTime=$dateIncludeTime, dateTimeFormat=$dateTimeFormat, dateShowTzinfo=$dateShowTzinfo, dateForceTimezone=$dateForceTimezone, dateForceTimezoneOffset=$dateForceTimezoneOffset]';
  ...
  /// Returns a new [LastModifiedFieldCreateField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LastModifiedFieldCreateField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LastModifiedFieldCreateField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LastModifiedFieldCreateField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LastModifiedFieldCreateField(
  ...
  static List<LastModifiedFieldCreateField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LastModifiedFieldCreateField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LastModifiedFieldCreateField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LastModifiedFieldCreateField> mapFromJson(dynamic json) {
    final map = <String, LastModifiedFieldCreateField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LastModifiedFieldCreateField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LastModifiedFieldCreateField-objects as value to a dart map
  static Map<String, List<LastModifiedFieldCreateField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LastModifiedFieldCreateField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LastModifiedFieldCreateField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
