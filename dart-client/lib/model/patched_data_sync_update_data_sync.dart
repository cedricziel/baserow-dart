...
class PatchedDataSyncUpdateDataSync {
  /// Returns a new [PatchedDataSyncUpdateDataSync] instance.
  PatchedDataSyncUpdateDataSync({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PatchedDataSyncUpdateDataSync &&
  ...
  @override
  String toString() => 'PatchedDataSyncUpdateDataSync[syncedProperties=$syncedProperties, icalUrl=$icalUrl, postgresqlHost=$postgresqlHost, postgresqlUsername=$postgresqlUsername, postgresqlPort=$postgresqlPort, postgresqlDatabase=$postgresqlDatabase, postgresqlSchema=$postgresqlSchema, postgresqlTable=$postgresqlTable, postgresqlSslmode=$postgresqlSslmode, sourceTableId=$sourceTableId, jiraUrl=$jiraUrl, jiraProjectKey=$jiraProjectKey, jiraUsername=$jiraUsername, githubIssuesOwner=$githubIssuesOwner, githubIssuesRepo=$githubIssuesRepo, gitlabUrl=$gitlabUrl, gitlabProjectId=$gitlabProjectId]';
  ...
  /// Returns a new [PatchedDataSyncUpdateDataSync] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PatchedDataSyncUpdateDataSync? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PatchedDataSyncUpdateDataSync[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PatchedDataSyncUpdateDataSync[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PatchedDataSyncUpdateDataSync(
  ...
  static List<PatchedDataSyncUpdateDataSync> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PatchedDataSyncUpdateDataSync>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PatchedDataSyncUpdateDataSync.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PatchedDataSyncUpdateDataSync> mapFromJson(dynamic json) {
    final map = <String, PatchedDataSyncUpdateDataSync>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PatchedDataSyncUpdateDataSync.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PatchedDataSyncUpdateDataSync-objects as value to a dart map
  static Map<String, List<PatchedDataSyncUpdateDataSync>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PatchedDataSyncUpdateDataSync>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PatchedDataSyncUpdateDataSync.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
