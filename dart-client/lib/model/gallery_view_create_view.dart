...
class GalleryViewCreateView {
  /// Returns a new [GalleryViewCreateView] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GalleryViewCreateView &&
    other.name == name &&
    other.type == type &&
  ...
  @override
  String toString() => 'GalleryViewCreateView[name=$name, type=$type, ownershipType=$ownershipType, filterType=$filterType, filtersDisabled=$filtersDisabled, cardCoverImageField=$cardCoverImageField, public=$public, slug=$slug]';
  ...
  /// Returns a new [GalleryViewCreateView] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GalleryViewCreateView? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GalleryViewCreateView[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GalleryViewCreateView[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return GalleryViewCreateView(
  ...
  static List<GalleryViewCreateView> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GalleryViewCreateView>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GalleryViewCreateView.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GalleryViewCreateView> mapFromJson(dynamic json) {
    final map = <String, GalleryViewCreateView>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GalleryViewCreateView.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GalleryViewCreateView-objects as value to a dart map
  static Map<String, List<GalleryViewCreateView>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GalleryViewCreateView>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GalleryViewCreateView.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
