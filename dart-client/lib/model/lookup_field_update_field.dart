...
class LookupFieldUpdateField {
  /// Returns a new [LookupFieldUpdateField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LookupFieldUpdateField &&
    other.name == name &&
    other.type == type &&
  ...
  /// Returns a new [LookupFieldUpdateField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LookupFieldUpdateField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LookupFieldUpdateField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LookupFieldUpdateField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LookupFieldUpdateField(
  ...
  static List<LookupFieldUpdateField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LookupFieldUpdateField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LookupFieldUpdateField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LookupFieldUpdateField> mapFromJson(dynamic json) {
    final map = <String, LookupFieldUpdateField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LookupFieldUpdateField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LookupFieldUpdateField-objects as value to a dart map
  static Map<String, List<LookupFieldUpdateField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LookupFieldUpdateField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LookupFieldUpdateField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
