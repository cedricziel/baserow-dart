...
class FieldSerializerWithRelatedFields {
  /// Returns a new [FieldSerializerWithRelatedFields] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FieldSerializerWithRelatedFields &&
    other.id == id &&
  ...
  @override
  String toString() => 'FieldSerializerWithRelatedFields[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description, relatedFields=$relatedFields]';
  ...
  /// Returns a new [FieldSerializerWithRelatedFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FieldSerializerWithRelatedFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FieldSerializerWithRelatedFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FieldSerializerWithRelatedFields[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FieldSerializerWithRelatedFields(
  ...
  static List<FieldSerializerWithRelatedFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FieldSerializerWithRelatedFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FieldSerializerWithRelatedFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FieldSerializerWithRelatedFields> mapFromJson(dynamic json) {
    final map = <String, FieldSerializerWithRelatedFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FieldSerializerWithRelatedFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FieldSerializerWithRelatedFields-objects as value to a dart map
  static Map<String, List<FieldSerializerWithRelatedFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FieldSerializerWithRelatedFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FieldSerializerWithRelatedFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
