...
class AuthFormElementElement {
  /// Returns a new [AuthFormElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthFormElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [AuthFormElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthFormElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AuthFormElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AuthFormElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AuthFormElementElement(
  ...
  static List<AuthFormElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthFormElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthFormElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthFormElementElement> mapFromJson(dynamic json) {
    final map = <String, AuthFormElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthFormElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthFormElementElement-objects as value to a dart map
  static Map<String, List<AuthFormElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthFormElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AuthFormElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
