...
class RecordSelectorElementElement {
  /// Returns a new [RecordSelectorElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RecordSelectorElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [RecordSelectorElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RecordSelectorElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RecordSelectorElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RecordSelectorElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RecordSelectorElementElement(
  ...
  static List<RecordSelectorElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RecordSelectorElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RecordSelectorElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RecordSelectorElementElement> mapFromJson(dynamic json) {
    final map = <String, RecordSelectorElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RecordSelectorElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RecordSelectorElementElement-objects as value to a dart map
  static Map<String, List<RecordSelectorElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RecordSelectorElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RecordSelectorElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
