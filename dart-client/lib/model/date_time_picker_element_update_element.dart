...
class DateTimePickerElementUpdateElement {
  /// Returns a new [DateTimePickerElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DateTimePickerElementUpdateElement &&
  ...
  /// Returns a new [DateTimePickerElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DateTimePickerElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DateTimePickerElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DateTimePickerElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DateTimePickerElementUpdateElement(
  ...
  static List<DateTimePickerElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DateTimePickerElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DateTimePickerElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DateTimePickerElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, DateTimePickerElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateTimePickerElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DateTimePickerElementUpdateElement-objects as value to a dart map
  static Map<String, List<DateTimePickerElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DateTimePickerElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DateTimePickerElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
