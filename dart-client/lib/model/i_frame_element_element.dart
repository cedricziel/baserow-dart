...
class IFrameElementElement {
  /// Returns a new [IFrameElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IFrameElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [IFrameElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IFrameElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IFrameElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IFrameElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IFrameElementElement(
  ...
  static List<IFrameElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IFrameElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IFrameElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IFrameElementElement> mapFromJson(dynamic json) {
    final map = <String, IFrameElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IFrameElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IFrameElementElement-objects as value to a dart map
  static Map<String, List<IFrameElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IFrameElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IFrameElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
