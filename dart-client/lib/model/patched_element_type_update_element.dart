...
class PatchedElementTypeUpdateElement {
  /// Returns a new [PatchedElementTypeUpdateElement] instance.
  PatchedElementTypeUpdateElement({
    this.visibility,
    this.styles,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PatchedElementTypeUpdateElement &&
  ...
  /// Returns a new [PatchedElementTypeUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PatchedElementTypeUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PatchedElementTypeUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PatchedElementTypeUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PatchedElementTypeUpdateElement(
  ...
  static List<PatchedElementTypeUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PatchedElementTypeUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PatchedElementTypeUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PatchedElementTypeUpdateElement> mapFromJson(dynamic json) {
    final map = <String, PatchedElementTypeUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PatchedElementTypeUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PatchedElementTypeUpdateElement-objects as value to a dart map
  static Map<String, List<PatchedElementTypeUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PatchedElementTypeUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PatchedElementTypeUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
