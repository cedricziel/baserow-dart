...
class LastModifiedByFieldField {
  /// Returns a new [LastModifiedByFieldField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LastModifiedByFieldField &&
    other.id == id &&
  ...
  @override
  String toString() => 'LastModifiedByFieldField[id=$id, tableId=$tableId, name=$name, order=$order, type=$type, primary=$primary, readOnly=$readOnly, immutableType=$immutableType, immutableProperties=$immutableProperties, description=$description]';
  ...
  /// Returns a new [LastModifiedByFieldField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LastModifiedByFieldField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LastModifiedByFieldField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LastModifiedByFieldField[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LastModifiedByFieldField(
  ...
  static List<LastModifiedByFieldField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LastModifiedByFieldField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LastModifiedByFieldField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LastModifiedByFieldField> mapFromJson(dynamic json) {
    final map = <String, LastModifiedByFieldField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LastModifiedByFieldField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LastModifiedByFieldField-objects as value to a dart map
  static Map<String, List<LastModifiedByFieldField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LastModifiedByFieldField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LastModifiedByFieldField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
