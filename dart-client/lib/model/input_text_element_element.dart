...
class InputTextElementElement {
  /// Returns a new [InputTextElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InputTextElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [InputTextElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InputTextElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InputTextElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InputTextElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return InputTextElementElement(
  ...
  static List<InputTextElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InputTextElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InputTextElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InputTextElementElement> mapFromJson(dynamic json) {
    final map = <String, InputTextElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InputTextElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InputTextElementElement-objects as value to a dart map
  static Map<String, List<InputTextElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InputTextElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InputTextElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
