...
class RepeatElementCreateElement {
  /// Returns a new [RepeatElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RepeatElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [RepeatElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RepeatElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RepeatElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RepeatElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RepeatElementCreateElement(
  ...
  static List<RepeatElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RepeatElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RepeatElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RepeatElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, RepeatElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RepeatElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RepeatElementCreateElement-objects as value to a dart map
  static Map<String, List<RepeatElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RepeatElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RepeatElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
