...
class AuthFormElementPublicElement {
  /// Returns a new [AuthFormElementPublicElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthFormElementPublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [AuthFormElementPublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthFormElementPublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AuthFormElementPublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AuthFormElementPublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AuthFormElementPublicElement(
  ...
  static List<AuthFormElementPublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthFormElementPublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthFormElementPublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthFormElementPublicElement> mapFromJson(dynamic json) {
    final map = <String, AuthFormElementPublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthFormElementPublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthFormElementPublicElement-objects as value to a dart map
  static Map<String, List<AuthFormElementPublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthFormElementPublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AuthFormElementPublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
