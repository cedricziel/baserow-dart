...
class DateTimePickerElementElement {
  /// Returns a new [DateTimePickerElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DateTimePickerElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [DateTimePickerElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DateTimePickerElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DateTimePickerElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DateTimePickerElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DateTimePickerElementElement(
  ...
  static List<DateTimePickerElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DateTimePickerElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DateTimePickerElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DateTimePickerElementElement> mapFromJson(dynamic json) {
    final map = <String, DateTimePickerElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DateTimePickerElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DateTimePickerElementElement-objects as value to a dart map
  static Map<String, List<DateTimePickerElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DateTimePickerElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DateTimePickerElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
