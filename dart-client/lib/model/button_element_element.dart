...
class ButtonElementElement {
  /// Returns a new [ButtonElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ButtonElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ButtonElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ButtonElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ButtonElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ButtonElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ButtonElementElement(
  ...
  static List<ButtonElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ButtonElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ButtonElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ButtonElementElement> mapFromJson(dynamic json) {
    final map = <String, ButtonElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ButtonElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ButtonElementElement-objects as value to a dart map
  static Map<String, List<ButtonElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ButtonElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ButtonElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
