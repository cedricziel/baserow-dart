...
class FormContainerElementCreateElement {
  /// Returns a new [FormContainerElementCreateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FormContainerElementCreateElement &&
    other.order == order &&
  ...
  /// Returns a new [FormContainerElementCreateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FormContainerElementCreateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FormContainerElementCreateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FormContainerElementCreateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FormContainerElementCreateElement(
  ...
  static List<FormContainerElementCreateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FormContainerElementCreateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FormContainerElementCreateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FormContainerElementCreateElement> mapFromJson(dynamic json) {
    final map = <String, FormContainerElementCreateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FormContainerElementCreateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FormContainerElementCreateElement-objects as value to a dart map
  static Map<String, List<FormContainerElementCreateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FormContainerElementCreateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FormContainerElementCreateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
