...
class CheckboxElementElement {
  /// Returns a new [CheckboxElementElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CheckboxElementElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [CheckboxElementElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CheckboxElementElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CheckboxElementElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CheckboxElementElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CheckboxElementElement(
  ...
  static List<CheckboxElementElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckboxElementElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckboxElementElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CheckboxElementElement> mapFromJson(dynamic json) {
    final map = <String, CheckboxElementElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CheckboxElementElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CheckboxElementElement-objects as value to a dart map
  static Map<String, List<CheckboxElementElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CheckboxElementElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CheckboxElementElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
