...
class ExampleRowRequestSerializerWithUserFieldNames {
  /// Returns a new [ExampleRowRequestSerializerWithUserFieldNames] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExampleRowRequestSerializerWithUserFieldNames &&
    other.field1 == field1 &&
    other.field2 == field2 &&
    other.field3 == field3 &&
    other.field4 == field4 &&
  ...
  @override
  String toString() => 'ExampleRowRequestSerializerWithUserFieldNames[field1=$field1, field2=$field2, field3=$field3, field4=$field4, field5=$field5, field6=$field6, field7=$field7, field8=$field8, field13=$field13, field14=$field14, field15=$field15, field16=$field16, field17=$field17, field18=$field18, field23=$field23, field26=$field26, field27=$field27]';
  ...
  /// Returns a new [ExampleRowRequestSerializerWithUserFieldNames] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExampleRowRequestSerializerWithUserFieldNames? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExampleRowRequestSerializerWithUserFieldNames[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExampleRowRequestSerializerWithUserFieldNames[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ExampleRowRequestSerializerWithUserFieldNames(
  ...
  static List<ExampleRowRequestSerializerWithUserFieldNames> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExampleRowRequestSerializerWithUserFieldNames>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExampleRowRequestSerializerWithUserFieldNames.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExampleRowRequestSerializerWithUserFieldNames> mapFromJson(dynamic json) {
    final map = <String, ExampleRowRequestSerializerWithUserFieldNames>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExampleRowRequestSerializerWithUserFieldNames.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExampleRowRequestSerializerWithUserFieldNames-objects as value to a dart map
  static Map<String, List<ExampleRowRequestSerializerWithUserFieldNames>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExampleRowRequestSerializerWithUserFieldNames>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExampleRowRequestSerializerWithUserFieldNames.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
