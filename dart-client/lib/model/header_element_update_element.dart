...
class HeaderElementUpdateElement {
  /// Returns a new [HeaderElementUpdateElement] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeaderElementUpdateElement &&
  ...
  /// Returns a new [HeaderElementUpdateElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HeaderElementUpdateElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HeaderElementUpdateElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HeaderElementUpdateElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HeaderElementUpdateElement(
  ...
  static List<HeaderElementUpdateElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HeaderElementUpdateElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HeaderElementUpdateElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HeaderElementUpdateElement> mapFromJson(dynamic json) {
    final map = <String, HeaderElementUpdateElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HeaderElementUpdateElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HeaderElementUpdateElement-objects as value to a dart map
  static Map<String, List<HeaderElementUpdateElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HeaderElementUpdateElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HeaderElementUpdateElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
