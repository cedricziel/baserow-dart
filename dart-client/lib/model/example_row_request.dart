...
class ExampleRowRequest {
  /// Returns a new [ExampleRowRequest] instance.
  ExampleRowRequest({
    this.field1,
    this.field2,
    this.field3,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExampleRowRequest &&
    other.field1 == field1 &&
    other.field2 == field2 &&
    other.field3 == field3 &&
    other.field4 == field4 &&
  ...
  @override
  String toString() => 'ExampleRowRequest[field1=$field1, field2=$field2, field3=$field3, field4=$field4, field5=$field5, field6=$field6, field7=$field7, field8=$field8, field13=$field13, field14=$field14, field15=$field15, field16=$field16, field17=$field17, field18=$field18, field23=$field23, field26=$field26, field27=$field27]';
  ...
  /// Returns a new [ExampleRowRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExampleRowRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExampleRowRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExampleRowRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ExampleRowRequest(
  ...
  static List<ExampleRowRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExampleRowRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExampleRowRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExampleRowRequest> mapFromJson(dynamic json) {
    final map = <String, ExampleRowRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExampleRowRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExampleRowRequest-objects as value to a dart map
  static Map<String, List<ExampleRowRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExampleRowRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExampleRowRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
