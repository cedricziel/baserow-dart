...
class Account {
  ...
  @override
  String toString() => 'Account[firstName=$firstName, language=$language, emailNotificationFrequency=$emailNotificationFrequency, completedOnboarding=$completedOnboarding]';
