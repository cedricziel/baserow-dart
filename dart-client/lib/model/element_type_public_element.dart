...
class ElementTypePublicElement {
  /// Returns a new [ElementTypePublicElement] instance.
  ElementTypePublicElement({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ElementTypePublicElement &&
    other.id == id &&
    other.pageId == pageId &&
    other.type == type &&
    other.order == order &&
  ...
  /// Returns a new [ElementTypePublicElement] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ElementTypePublicElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ElementTypePublicElement[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ElementTypePublicElement[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ElementTypePublicElement(
  ...
  static List<ElementTypePublicElement> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ElementTypePublicElement>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ElementTypePublicElement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ElementTypePublicElement> mapFromJson(dynamic json) {
    final map = <String, ElementTypePublicElement>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ElementTypePublicElement.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ElementTypePublicElement-objects as value to a dart map
  static Map<String, List<ElementTypePublicElement>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ElementTypePublicElement>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ElementTypePublicElement.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
